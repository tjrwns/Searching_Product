...
then
{
	...
	cp $file_name__api_server_122 $file_name__api_server_original
	echo "$file_name__api_server_122 파일 복사"
}
fi
...
then
{
	...
	cp $file_name__http_server_122 $file_name__http_server_original
	echo "$file_name__http_server_122 파일 복사"
}
fi
...
then
{
	...
	cp $file_name__web_db_122 $file_name__web_db_original
	echo "$file_name__web_db_122 파일 복사"
}
fi
...
then
{
	...
	cp $file_name__web_server_122 $file_name__web_server_original
	echo "$file_name__web_server_122 파일 복사"
}
fi
