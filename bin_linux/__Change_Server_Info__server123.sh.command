...
then
{
	...
	cp $file_name__api_server_123 $file_name__api_server_original
	echo "$file_name__api_server_123 파일 복사"
}
fi
...
then
{
	...
	cp $file_name__http_server_123 $file_name__http_server_original
	echo "$file_name__http_server_123 파일 복사"
}
fi
...
then
{
	...
	cp $file_name__web_db_123 $file_name__web_db_original
	echo "$file_name__web_db_123 파일 복사"
}
fi
...
then
{
	...
	cp $file_name__web_server_123 $file_name__web_server_original
	echo "$file_name__web_server_123 파일 복사"
}
fi
