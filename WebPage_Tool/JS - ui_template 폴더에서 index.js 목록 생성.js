...
var FNS = {
	getHTMLIDFromPath : function( path ){
		var HTMLElementID = "ui/" + path.replace( PATH000, "" ).replace( ".js", "" );
...
var FN_CHECK__FILE = function( path ){
	var a = SUtilFsReadStream.getList_File_Extension( path, ".js" );
	var io;
...
var PATH000 = "D:/GitHub_B2LiNK/B2LiNK-OnSight-Dev/WebPage_Tool/JS - ui_template 폴더에서 index.js 목록 생성";
