...
var _TDBJS = SUtilFsReadStream.getFile( _ROOT_PATH_ + "/001 - insert - siteInfo.tdbjs" ).toString();
var TBDJS = _TDBJS.replace("<!=data=!>", JSON.stringify(r,null,4) ).replace("<!=date=!>",  TARGET_DATE );

SUtilFsWriteStream.writeFile( _WRITE_FILE_PATH + "CATEGORY.SITE--import--" + TARGET_DATE +".dbjs", TBDJS )
