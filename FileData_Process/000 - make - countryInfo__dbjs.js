...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - make - countryInfo__dbjs";
...
var _TDBJS = SUtilFsReadStream.getFile( _ROOT_PATH_ + "/001 - insert - countryInfo.tdbjs" ).toString();
var TBDJS = _TDBJS.replace("<!=data=!>", JSON.stringify(r,null,4) );

SUtilFsWriteStream.writeFile( _WRITE_FILE_PATH + "CATEGORY.COUNTRY--import--" + TARGET_DATE +".dbjs", TBDJS )
