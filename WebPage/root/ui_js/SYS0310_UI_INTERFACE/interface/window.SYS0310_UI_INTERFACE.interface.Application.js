//----------------------------------------------------------------------------------------------------;
var fileNm = "ui_js/SYS0310_UI_INTERFACE/interface/window.SYS0310_UI_INTERFACE.interface.Application.js";
...
(function(){
	...
	var _checkInterface = function(){
		...
		for( var s in this )
		{
			...
			{
				if( !_checkInterface.interfaces[ s ] )
				{
				}
	 ...
	 * @return {Object}
	 */
	window.SYS0310_UI_INTERFACE.interface.Application = function( T )
	{
