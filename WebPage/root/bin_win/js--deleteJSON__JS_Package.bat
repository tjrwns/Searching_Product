...
call del /s /q ..\js__b2link__SYS0310\__list.json
call del /s /q ..\js__b2link__SYS0310\__listDir.json
call del /s /q ..\js__b2link__SYS0310\__listPackage.json

call del /s /q ..\js-libs\__list.json
call del /s /q ..\js-libs\__listDir.json
call del /s /q ..\js-libs\__listPackage.json

call del /s /q ..\ui_js\__list.json
call del /s /q ..\ui_js\__listDir.json
call del /s /q ..\ui_js\__listPackage.json
