...
find ../js__b2link__SYS0310/ -name '__list.json' -exec rm -f {} \;
find ../js__b2link__SYS0310/ -name '__listDir.json' -exec rm -f {} \;
find ../js__b2link__SYS0310/ -name '__listPackage.json' -exec rm -f {} \;

find ../js-libs/ -name '__list.json' -exec rm -f {} \;
find ../js-libs/ -name '__listDir.json' -exec rm -f {} \;
find ../js-libs/ -name '__listPackage.json' -exec rm -f {} \;

find ../ui_js/ -name '__list.json' -exec rm -f {} \;
find ../ui_js/ -name '__listDir.json' -exec rm -f {} \;
find ../ui_js/ -name '__listPackage.json' -exec rm -f {} \;
