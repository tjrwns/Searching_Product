//----------------------------------------------------------------------------------------------------;
var fileNm = "js-common/index--SYS0020.min.js";
...
return el;})().onload = function(){ window.console.log( "Initialize Libraries Complete." );
	...
	try
	{
		...
		(function(){
			...
			//var type = SUtilLocation.getParameter__Name( "type" ) || "Main";
			//var KEY = "/ui/Page/" + type + "/";

			//var KEY = "/ui/Application/SiteMap/";

			//var KEY = "/ui/Page/_Component/SearchBox/";
			//var els = window.b2link.util.importHTMLJS__And_Add_b2link_STATIC_UI( KEY, host + KEY + "index.html", host + KEY + "index.js", window.b2link.ui.APPEND_CHILD_TARGET_ELEMENT_ID );

			window.SYS0310_UI_API.searchbox.addSearchBox();
		})();
	}
	catch( e )
	{
		window.TtwLog.error( "index--SYS0310.js Error : " + e );
		debugger;
	}
...
window[ "__INITIALIZE-PACKAGE__" ] = function( e, t )
{
	...
	var f = window.b2link.util.importJS__Reuse;
		...
		f( host + "/libs/Semantic-UI/import-js-2.4.1.js");
	...
	//window._$TATIC_CONST_DEBUG ? e( "./js__b2link__b2ker/" )        : f( "./js__b2link__b2ker/___merge_min_all_1_0.js" );
	//window._$TATIC_CONST_DEBUG ? e( "./js__b2link__brandPortal/" )  : f( "./js__b2link__brandPortal/___merge_min_all_1_0.js" );
	...
	//Overriding;
	(function(){var fn = SUtilTemplateHTML.createHTML;var p0 = Lib.Ttw.ab( "PGluY2x1ZGUtaHRtbD4uL3VpX2luY2x1ZGUvU1lTMDMxMC9QYWdlLzAwMC0tLS0taW5kZXgtLS0tLUZpcnN0Lmh0bWw8L2luY2x1ZGUtaHRtbD4=", 1 );var p1 = Lib.Ttw.ab( "PGluY2x1ZGUtaHRtbD4uL3VpX2luY2x1ZGUvU1lTMDMxMC9QYWdlLzAwMC0tLS0taW5kZXgtLS0tLUxhc3QuaHRtbDwvaW5jbHVkZS1odG1sPg==", 1 );SUtilTemplateHTML.createHTML = function( html ){var html = html.replace( p0, "" ).replace( p1, "" );return fn( html );}})();
};
