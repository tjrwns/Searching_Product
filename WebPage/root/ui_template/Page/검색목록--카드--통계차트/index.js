/*/
http://localhost:49781/ui/Page/검색목록--카드--통계차트/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/검색목록--카드--통계차트/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/검색목록--카드--통계차트/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/검색목록--카드--통계차트/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/검색목록--카드--통계차트/index.html?url=http://localhost:49781/ui/Page/검색목록--카드--통계차트/index.json
http://dnsproxy.shop:49781/ui/Page/검색목록--카드--통계차트/index.html?url=http://dnsproxy.shop:49781/ui/Page/검색목록--카드--통계차트/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/검색목록--카드--통계차트/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/검색목록--카드--통계차트/index"
	};
})();
...
var _COMPONENTS = (function(){
	var o = {
		ECHART00 : { ELEMENT : null, CTRL : null }
		, ECHART00 : { ELEMENT : null, CTRL : null }
	};
...
var _redraw = function( data, options )
{
	...
	//_draw( data, options );
	debugger;
	window.SYS0310_UI_API.echart.addBar( _IDS.ROOT );
};
