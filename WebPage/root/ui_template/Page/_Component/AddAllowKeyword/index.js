/*/
http://localhost:49781/ui/Page/_Component/AddAllowKeyword/index.html?width=200&height=26

http://localhost:49781/ui/Page/_Component/AddAllowKeyword/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/AddAllowKeyword/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/AddAllowKeyword/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/AddAllowKeyword/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/AddAllowKeyword/index.html?url=http://localhost:49781/ui/Page/_Component/AddAllowKeyword/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/AddAllowKeyword/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/AddAllowKeyword/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/AddAllowKeyword/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/AddAllowKeyword/index"
	};
})();
...
var _ELS = (function(){
	...
	o.INPUT__ALLOWKEYWORD = f0( o.ROOT, "input__allowKeyword" );
...
var _URLS = (function(){
	...
	var o = {
		addAllowKeyword : HOST + "/reqKeyword/crud/addAllowKeyword?keyword=<!=KEYWORD=!>&cd$BRAND=<!=CD$BRAND=!>&cd$COUNTRY_k=<!=CD$COUNTRY_k=!>"
	};
...
var _addEvent = function()
{
	...
	_ELS.INPUT__ALLOWKEYWORD.addEventListener( "keyup", _evt_keyup__input_allowkeyword, false, 0, true );

	window.RayLog.timeStamp( " [ E ] - _addEvent():void----------" );
};

/**
 * input__allowkeyword 엔터 처리 
 * @function
 * @param event {Event}
 */
var _evt_keyup__input_allowkeyword = function( event ){	if( event.keyCode != 13) return; _reqData(); };
...
var _removeEvent = function()
{
	...
	window.removeEventListener( "keyup", _evt_keyup__input_allowkeyword, false );
...
var _reqData = function( url, cbComplete )
{
	...
	//----------URI PARAMETERS;
	var _keyword = _ELS.INPUT__ALLOWKEYWORD.value;
	...
	var url = _URLS.addAllowKeyword.replace( "<!=KEYWORD=!>", _keyword )
...
_reqData.complete = function( responseData )
{
	...
	_ELS.INPUT__ALLOWKEYWORD.value = "";
