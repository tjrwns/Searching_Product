/*/
http://localhost:49781/ui/Page/_Component/AddKeyword__Allow/index.html?width=200&height=26

http://localhost:49781/ui/Page/_Component/AddKeyword__Allow/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/AddKeyword__Allow/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/AddKeyword__Allow/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/AddKeyword__Allow/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/AddKeyword__Allow/index.html?url=http://localhost:49781/ui/Page/_Component/AddKeyword__Allow/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/AddKeyword__Allow/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/AddKeyword__Allow/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/AddKeyword__Allow/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/AddKeyword__Allow/index"
	};
})();
...
var _ELS = (function(){
	...
	o.INPUT__KEYWORD = f0( o.ROOT, "input__keyword" );
...
var _addEvent = function()
{
	...
	_ELS.INPUT__KEYWORD.addEventListener( "keyup", _evt_keyup__input_keyword, false, 0, true );
...
{
	_ELS.BTN__ADD.removeEventListener( "click", _reqData, false );

	_ELS.INPUT__KEYWORD.removeEventListener( "keyup", _evt_keyup__input_keyword, false );
};

/**
 * input__keyword 엔터 처리
 * @function
 * @param event {Event}
 */
var _evt_keyup__input_keyword = function( event ){ if( event.keyCode != 13 ) return; _reqData(); };
...
var _reqData = function( url, cbComplete ){ 
	...
	var _keyword = _ELS.INPUT__KEYWORD.value;
	_reqData.checkKeyword( _keyword, _reqData.checkKeyword.complete ); 
};


/**
 * input box에 입력된 키워드가 허용된 키워드인지를 판별한다.
 * @function
 * @param {String} keyword
 */
_reqData.checkKeyword = function( keyword, cbFunction ){
	var url = _URLS.checkAllowKeyword.replace( "<!=KEYWORD=!>", keyword );
	window.b2link_service.common._fn_req( url, cbFunction );
};

/**
 * _reqData.checkKeyword 의 cb 함수. 
 * 허용여부를 판단하여, 허용일경우 등록을 요청한다.
 * @function
 * @param {String} responseData
 */
_reqData.checkKeyword.complete = function( responseData ){
	...
	if( responseData.data.bFind )
	{
		_reqData_AddKeyword_Allow();
	}
	else
	{
		window.b2link_ui.message.error( "허용된 검색어가 아닙니다." );
	}
};

/**
 * keyword validation 없이 키워드를 등록한다. 
 * @function
 */
var _reqData_AddKeyword_Allow = function( ){

	//----------URI PARAMETERS;
	var keyword = _ELS.INPUT__KEYWORD.value;
	...
	window.b2link_service.common._fn_req( url, _reqData_AddKeyword.complete );
};


/**
 * _reqData_AddKeyword 의 후처리 함수;
 * @function
 ...
 * </code>
 */
_reqData_AddKeyword_Allow.complete = function( responseData ){
