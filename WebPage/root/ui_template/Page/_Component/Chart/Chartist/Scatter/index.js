/*/
http://localhost:49781/ui/Page/_Component/Chart/Chartist/Scatter/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/Chartist/Scatter/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/Chartist/Scatter/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/Chartist/Scatter/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/Chart/Chartist/Scatter/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/Chartist/Scatter/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Chartist/Scatter/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Chartist/Scatter/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/Chartist/Scatter/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/Chartist/Scatter/index"
	};
})();
...
var _DATA = (function(){
	...
	return {
		data : {
			...
			, series : [[48,60,117,99,71,43,107,87,104,15],[108,23,48,40,63,33,92,24,26,97],[53,97,34,56,16,56,101,33,28,65],[65,110,44,60,22,59,53,109,41,44],[59,76,108,22,104,74,84,34,41,48],[12,106,85,41,107,38,35,63,93,116],[75,81,57,61,27,114,99,64,96,63],[117,52,71,23,105,119,22,28,93,26],[58,10,93,67,35,48,119,77,79,19],[41,74,85,91,25,73,64,107,120,117]]
		}
		, width : ( d.width || 500 )
		, height : ( d.height || 500 )
	};
...
var _createOptions = function( data )
{
	...
	_OPTIONS.showLine = false;//항상 false;
 ...
 * <code>
	{
		data : {
			labels : [ "a", "b", "c", "d", "e", "f", "g", "h", "i", "j" ]
			, series : [[105,21,23,99,10,35,101,52,102,113],[74,108,59,33,42,28,19,44,98,91],[22,86,67,78,48,19,82,112,24,27],[105,75,60,37,24,57,24,74,62,27],[17,63,63,85,113,49,85,105,27,78],[120,42,34,106,105,106,49,63,10,63],[78,24,38,10,102,26,91,44,96,81],[120,50,54,95,11,39,37,81,27,23],[72,43,14,93,50,108,66,26,112,111],[39,18,95,83,74,30,65,56,104,120]]
		}
		, width : 300
		, height : 300
	}
