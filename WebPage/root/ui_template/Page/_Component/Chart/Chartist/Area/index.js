/*/
http://localhost:49781/ui/Page/_Component/Chart/Chartist/Area/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/Chartist/Area/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/Chartist/Area/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/Chartist/Area/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/Chart/Chartist/Area/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/Chartist/Area/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Chartist/Area/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Chartist/Area/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/Chartist/Area/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/Chartist/Area/index"
	};
})();
...
var _DATA = (function(){
	...
	return {
		...
		, showLine : false
		, fullWidth : true
		, lineSmooth : window.Chartist.Interpolation.cardinal({ tension: 1 })
	};
	////[ SAMPLE ] - [ E ] - 자동 삭제;
})();
...
var _OPTIONS = {
	...
	, showLine : true
	, fullWidth : true
	, lineSmooth : window.Chartist.Interpolation.cardinal({ tension: 0 })
...
var _createOptions = function( data )
{
	...
	///if( data.hasOwnProperty( "showArea" ) _OPTIONS.showArea = data.showArea;//항상 true;
	if( data.hasOwnProperty( "showLine" ) ) _OPTIONS.showLine = data.showLine;
	if( data.hasOwnProperty( "fullWidth" ) ) _OPTIONS.fullWidth = data.fullWidth;
	if( data.axisX && "object" == typeof( data.axisX ) ) _OPTIONS.axisX = data.axisX;
	if( data.axisY && "object" == typeof( data.axisY ) ) _OPTIONS.axisY = data.axisY;
	if( data.lineSmooth && "function" == typeof( data.lineSmooth ) ) _OPTIONS.lineSmooth = data.lineSmooth;
...
var _draw = function( data, options )
{
	...
	//그리기;
	if( !_CHARTIST.CHART ) _CHARTIST.CHART = new Chartist.Line( _ELS.ROOT, data.data, options, options_responsive );
...
var _setOptions = function( options )
{
	...
	{
		//_OPTIONS 덮어쓰기 로직 작성;
		_OPTIONS.showArea = true;//항상 true;
		if( options.width ) _OPTIONS.width = options.width;
		if( options.height ) _OPTIONS.height = options.height;
		if( options.hasOwnProperty( "showLine" ) ) _OPTIONS.showLine = options.showLine;
		if( options.hasOwnProperty( "fullWidth" ) ) _OPTIONS.fullWidth = options.fullWidth;
		if( options.axisX && "object" == typeof( options.axisX ) ) _OPTIONS.axisX = options.axisX;
		if( options.axisY && "object" == typeof( options.axisY ) ) _OPTIONS.axisY = options.axisY;
		if( options.lineSmooth && "function" == typeof( options.lineSmooth ) ) _OPTIONS.lineSmooth = options.lineSmooth;
