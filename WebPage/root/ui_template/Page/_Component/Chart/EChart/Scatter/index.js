/*/
http://localhost:49781/ui/Page/_Component/Chart/EChart/Scatter/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Scatter/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/Scatter/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Scatter/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/Chart/EChart/Scatter/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/Scatter/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Scatter/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/Scatter/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/Scatter/index"
	};
})();
...
var _DATA = (function(){
	...
	return {
		legend : [ "1990", "2015" ]
		, data : [
			//[ y축 값, x축 값, value, value_name, legned_name ];
			[
				  [ 77, 28604, 17096869, "Australia", 1990 ]
				, [77.4, 31163, 27662440, "Canada", 1990 ]
			]
			//[ y축 값, x축 값, value, value_name, legned_name ];
			, [
				  [ 81.8, 44056, 23968973, "Australia", 2015 ]
				, [ 81.7, 43294, 35939927, "Canada", 2015 ]
				, [ 76.9, 13334, 1376048943, "China", 2015 ]
			]
		]
		, width : ( d.width || 200 )
		, height : ( d.height || 200 )
...
var _OPTIONS = (function(){
	...
	o.symbolSize = function( data ){ return Math.sqrt( data[ 2 ] ) / 5e2; };
	o.label = { emphasis : { show : true, formatter : function( param ){ return param.data[ 3 ]; }, position : "top" } };
	o.itemStyle = {
		normal : {
			shadowBlur : 10,
...
var _createOptions = function( d )
{
	...
	for( ; i<iLen; ++i )
	{
		...
		//y,x축 값 교환;
		io = io.map(function( item ){ return [ item[ 1 ], item[ 0 ], item[ 2 ], item[ 3 ], item[ 4 ] ]; });

		var o = { type : "scatter" };
			o.name = d.legend [ i ];
			o.data = io;
			//o.itemStyle = _OPTIONS.itemStyle;
			o.label = _OPTIONS.label;
			o.markPoint = { data : [ { type : "max" }, { type : "min" } ] };
			o.markLine = { data : [ { type : "average" } ] };
			o.symbolSize = _OPTIONS.symbolSize;
...
/**
 * Chart - EChart Scatter
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addScatter();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/Scatter/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
