/*/
http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.json

http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index"
	};
})();
...
var _createOptions = function( d )
{
	...
	for( ; i<iLen; ++i )
	{
		...
		var o = {};
			...
			o.type = "bar";
			o.data = io;
			o.label = { normal: { show: true, position: 'insideTop' } };
			o.stack = "stack";
	...
	obj_xAxis.data =  d.axis;
	arr_xAxis.push( obj_xAxis );

	//chart option 설정;
	_OPTIONS.legend.data = d.legend;//chart option - 레전드 설정;
	_OPTIONS.xAxis = arr_xAxis;//chart option - x축 설정;
...
/**
 * Chart - EChart Bar-V-Stacked
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addBar-V-Stacked();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-V-Stacked/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
