/*/
http://localhost:49781/ui/Page/_Component/Chart/EChart/Tree/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Tree/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/Tree/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Tree/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/Chart/EChart/Tree/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/Tree/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Tree/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/Tree/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/Tree/index"
	};
})();
...
var _OPTIONS = {
	series : [
		{
			type : "tree", data : null, top : "1%", left : "7%", bottom : "1%", right : "20%"
			, expandAndCollapse : true, animationDuration : 550, animationDurationUpdate : 750
			, label : { normal : { position : "left", verticalAlign : "middle", align : "right", fontSize : 15 } }
...
var _createOptions = function( d )
{
	...
	var s_idx=0;
	for( var s in d.data.children )
	{
		if( s_idx % 2 == 0 ) d.data.children[ s ].collapsed = true;
		++s_idx;
	}
 ...
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addTree();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/Tree/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
