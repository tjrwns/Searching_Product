/*/
http://localhost:49781/ui/Page/_Component/Chart/EChart/Heatmap/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Heatmap/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/Heatmap/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Heatmap/index.html?width=100%25&height=100%25&

http://localhost:49781/ui/Page/_Component/Chart/EChart/Heatmap/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/Heatmap/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Heatmap/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/Heatmap/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/Heatmap/index"
	};
})();
...
var _OPTIONS = {
	...
	, series : [
		{
			name : "Punch Card", type : "heatmap", data : null, label : { normal : { show : true } }
	...
	, xAxis : { type : "category", data : null, splitArea : { show : true } }
	, yAxis : { type : "category", data : null, splitArea : { show : true } }
};
...
{
	if( !d.data || !d.xaxis || !d.yaxis )
	{
		window.TtwLog.error( "[ ERROR ] - _createOptions : d 가 불충분함" );
		return;
	}

	d.data = d.data.map( function( item ){ return [ item[ 1 ], item[ 0 ], item[ 2 ] || "-" ]; } );

	// chart option 설정;
	_OPTIONS.yAxis.data = d.yaxis;// chart option - 레전드 설정;
	_OPTIONS.xAxis.data = d.xaxis;// chart option - x축 설정;
	_OPTIONS.series[ 0 ].data = d.data;// chart option - 시리즈 설정;
};
...
/**
 * Chart - EChart Heatmap
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addHeatmap();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/Heatmap/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
