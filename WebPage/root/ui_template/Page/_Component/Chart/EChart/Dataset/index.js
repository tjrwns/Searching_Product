/*/
//수정하기 - 김현요 - 이건 뭔가 컴포넌트가 아니라 그냥 샘플 페이지가 하드코딩 되있는 상태로 보임;

http://localhost:49781/ui/Page/_Component/Chart/EChart/Dataset/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Dataset/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/Dataset/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Dataset/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/Chart/EChart/Dataset/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/Dataset/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Dataset/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/Dataset/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/Dataset/index"
	};
})();
...
var _createOptions = function( d )
{
	...
	//시리즈 설정;
	var i=1,iLen=d.data.length;
	for( ; i<iLen; ++i ) series.push({ type : "line", smooth : true, seriesLayoutBy : "row" });
	...
	series.push({
		...
		, label : {
			//formatter : "{b}: {@2012} ({d}%)"
			formatter : function( d ){ return d.name + " : " + d.data[ d.dataIndex + 1  ] + " (" + d.percent + "%)"; }
		}
		, radius : "30%", center : [ "50%", "25%" ]
	});

	//chart option 설정;
	_OPTIONS.dataset.source = d.data;//chart option - dataset 설정;
...
/**
 * Chart - EChart Dataset
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addDataset();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/Dataset/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
