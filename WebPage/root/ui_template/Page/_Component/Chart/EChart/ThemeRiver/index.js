/*/
http://localhost:49781/ui/Page/_Component/Chart/EChart/ThemeRiver/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/ThemeRiver/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/ThemeRiver/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/ThemeRiver/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/Chart/EChart/ThemeRiver/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/ThemeRiver/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/ThemeRiver/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/ThemeRiver/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/ThemeRiver/index"
	};
})();
 ...
 * <code>
	{
		series: {
			type : "themeRiver", itemStyle: { emphasis: { shadowBlur: 20, shadowColor: "rgba(0, 0, 0, 0.8)" } }
			, data: null
		}
		, singleAxis: {
			top: 50
...
var _createOptions = function( d )
{
	...
	_OPTIONS.series.links = d.links;//chart option - 시리즈 설정;
};
...
/**
 * Chart - EChart ThemeRiver
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addThemeRiver();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/ThemeRiver/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
