/*/
http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked_Area/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked_Area/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked_Area/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked_Area/index.html?width=100%25&height=100%25&

http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked_Area/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked_Area/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Line_Stacked_Area/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/Line_Stacked_Area/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/Line_Stacked_Area/index"
	};
})();
...
function initialize()
{
	try
	{
		...
		_ECHART.CHART.on( "click", "series.line", function ( params ) {
...
var _createOptions = function( d )
{
	...
	for( ; i<iLen; ++i )
	{
		...
		var o = {};
			...
			// o.markLine_Stacked_Area = { data : [ { type : "average" } ] };
...
/**
 * Chart - EChart Line_Stacked_Area
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addLine_Stacked_Area();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked_Area/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
