/*/
http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.json

http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index"
	};
})();
...
var _OPTIONS = {
	//title : { text : "某地区蒸发量和降水量", subtext : "纯属虚构" }
	  calculable : true
	// Bar-Stacked-Horizontal 일때 dataZoom 버그 존재;
	...
	// , visualMap : { type : "continuous" , itemHeight : 200 , text : [ "High", "Low" ] , min : 0 }
	, xAxis : [ { type : "value" } ]
	, yAxis : null
};
...
function initialize()
{
	try
	{
		...
		_ECHART.CHART.on( "click", "series.bar", function ( params ) {
			window.b2link.event.dispatchCE__LIST_SELECTED_ITEM( _ELS.ROOT, params );
		});
...
var _createOptions = function( d )
{
	...
	for( ; i<iLen; ++i )
	{
		...
		var o = {};
			...
			o.data = io;
			o.stack = "stack";
			o.label = { normal: { show: true, position: 'insideRight' } };
			// o.markPoint = { data : [ { type : "max" }, { type : "min" } ] };
			// o.markLine = { data : [ { type : "average" } ] };

		series.push( o );
	}

	//y축 설정;
	obj_yAxis.type = "category";
	obj_yAxis.inverse = true;
	obj_yAxis.data =  d.axis;
	arr_yAxis.push( obj_yAxis );

	//chart option 설정;
	_OPTIONS.legend.data = d.legend;//chart option - 레전드 설정;
	_OPTIONS.yAxis = arr_yAxis;//chart option - y축 설정;
...
/**
 * Chart - EChart Bar-H-Stacked
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addBar-H-Stacked();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/Bar-H-Stacked/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
