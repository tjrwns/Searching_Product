/*/
http://localhost:49781/ui/Page/_Component/Chart/EChart/Treemap/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Treemap/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/Treemap/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Treemap/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/Chart/EChart/Treemap/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/Treemap/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Treemap/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/Treemap/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/Treemap/index"
	};
})();
...
var _OPTIONS__SAMPLE = {
	...
	, series : [
		//These series are in the first grid.;
		  { type : "treemap", seriesLayoutBy : "row" }
		, { type : "treemap", seriesLayoutBy : "row" }
		, { type : "treemap", seriesLayoutBy : "row" }

		//These series are in the second grid.;
		, { type : "treemap", xAxisIndex : 1, yAxisIndex : 1 }
		, { type : "treemap", xAxisIndex : 1, yAxisIndex : 1 }
		, { type : "treemap", xAxisIndex : 1, yAxisIndex : 1 }
		, { type : "treemap", xAxisIndex : 1, yAxisIndex : 1 }
	]
	, tooltip : {}
	, visualMap : { type : "continuous", calculable : true, dimension : 1, text : [ "High", "Low" ]
		, controller : { inRange : { color : "#2f4554" } }
...
var _createOptions = function( d )
{
	...
	//chart option 설정;
	_OPTIONS.series = [ { type: "treemap", data: d.data } ];//chart option - 시리즈 설정;
};
...
/**
 * Chart - EChart Treemap
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addTreemap();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/Treemap/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
