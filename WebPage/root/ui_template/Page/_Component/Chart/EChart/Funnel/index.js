/*/
http://localhost:49781/ui/Page/_Component/Chart/EChart/Funnel/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Funnel/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/Funnel/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Funnel/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/Chart/EChart/Funnel/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/Funnel/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Funnel/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/Funnel/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/Funnel/index"
	};
})();
...
var _createOptions = function( d )
{
	...
	if( d.title ) _OPTIONS.title = { text : d.title };
	...
	_OPTIONS.series[ 0 ].data = series;// chart option - 시리즈 설정;
};
 ...
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addFunnel();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/Funnel/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
