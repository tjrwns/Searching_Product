/*/
http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked/index.html?width=100%25&height=100%25&

http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/EChart/Line_Stacked/index.html?url=http://dnsproxy.shop:49780/country/brand
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/EChart/Line_Stacked/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/EChart/Line_Stacked/index"
	};
})();
...
var _createOptions = function( d )
{
	...
	for( ; i<iLen; ++i )
	{
		...
		var o = {};
			...
			// o.markLine_Stacked = { data : [ { type : "average" } ] };
...
/**
 * Chart - EChart Line_Stacked
 * @example
 * <code>
 	var els = window.SYS0310_UI_API.echart.addLine_Stacked();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/EChart/Line_Stacked/index.json" });
		els[ 1 ].redraw();
 * </code>
 */
(function(){
