/*/
http://localhost:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html

//사이즈 설정;
http://localhost:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html?width=500&height=500
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html?width=100%25&height=800
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html?width=100%25&height=500
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html?width=100%25&height=100%25&
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html?width=100%25&height=100%25&


http://localhost:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html?url=http://localhost:49781/ui/Page/_Component/Chart/Sparkline/Area/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Sparkline/Area/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Sparkline/Area/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/Chart/Sparkline/Area/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/Chart/Sparkline/Area/index"
	};
})();
...
var _setOptions = function( d )
{
	...
	if( d )
	{
		...
		//Line OPTIONS ----------;
		if( d.defaultPixelsPerValue ) _OPTIONS.defaultPixelsPerValue = d.defaultPixelsPerValue;
		if( d.spotColor ) _OPTIONS.spotColor = d.spotColor;
		if( d.minSpotColor ) _OPTIONS.minSpotColor = d.minSpotColor;
		if( d.maxSpotColor ) _OPTIONS.maxSpotColor = d.maxSpotColor;
		if( d.spotRadius ) _OPTIONS.spotRadius = d.spotRadius;
		if( d.valueSpots ) _OPTIONS.valueSpots = d.valueSpots;
		if( d.highlightSpotColor ) _OPTIONS.highlightSpotColor = d.highlightSpotColor;
		if( d.highlightLineColor ) _OPTIONS.highlightLineColor = d.highlightLineColor;
		if( d.lineWidth ) _OPTIONS.lineWidth = d.lineWidth;
		if( d.normalRangeMin ) _OPTIONS.normalRangeMin = d.normalRangeMin;
		if( d.normalRangeMax ) _OPTIONS.normalRangeMax = d.normalRangeMax;
		if( d.drawNormalOnTop ) _OPTIONS.drawNormalOnTop = d.drawNormalOnTop;
		if( d.xvalues ) _OPTIONS.xvalues = d.xvalues;
		if( d.chartRangeClip ) _OPTIONS.chartRangeClip = d.chartRangeClip;
		if( d.chartRangeMinX ) _OPTIONS.chartRangeMinX = d.chartRangeMinX;
		if( d.chartRangeMaxX ) _OPTIONS.chartRangeMaxX = d.chartRangeMaxX;
	}
	else
	{
	}
 ...
 * <code>
 	var els = window.SYS0310_UI_API.sparkline.addArea();
		els[ 1 ].setData({ url : "http://localhost:49781/ui/Page/_Component/Chart/Sparkline/Area/index.json" });
		//els[ 1 ].setData({ url : "http://dnsproxy.shop:49781/ui/Page/_Component/Chart/Sparkline/Area/index.json" });
