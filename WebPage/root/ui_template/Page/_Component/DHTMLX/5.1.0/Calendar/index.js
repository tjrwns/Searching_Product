/*/
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Calendar/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Calendar/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Calendar/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Calendar/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Calendar/index.html?url=http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Calendar/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/DHTMLX/5.1.0/Calendar/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/DHTMLX/5.1.0/Calendar/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/DHTMLX/5.1.0/Calendar/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/DHTMLX/5.1.0/Calendar/index"
	};
})();
...
var _ELS = (function(){
	...
	o.INPUT = f( o.ROOT, "ui/Page/_Component/DHTMLX/5.1.0/Calendar/index__input" );
	o.DIV = f( o.ROOT, "ui/Page/_Component/DHTMLX/5.1.0/Calendar/index__calendar" );
...
function initialize()
{
	try
	{
		...
		else if( !initialize._bInit && window.dhtmlXCalendarObject )
		{
...
var _draw = function( data, options )
{
	...
	_ELS.INPUT.id = _ELS.INPUT.className + "--" + SUtilMath.getUnique();
	_ELS.DIV.id = _ELS.DIV.className + "--" + SUtilMath.getUnique();

	if( !_DHTMLX.CALENDAR )
	{
		if( _OPTIONS.input ) _DHTMLX.CALENDAR = new dhtmlXCalendarObject([ _ELS.INPUT.id ]);
		else
		{
			_ELS.INPUT.style.display = "none";
			_DHTMLX.CALENDAR = new dhtmlXCalendarObject( _ELS.DIV.id );
...
var _getDate = function(){ return _DHTMLX.CALENDAR.getDate(); };
var _setDate = function( date ){ _DHTMLX.CALENDAR.setDate( date ); };
