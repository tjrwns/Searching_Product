/*/
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Scheduler/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Scheduler/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Scheduler/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Scheduler/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Scheduler/index.html?url=http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Scheduler/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/DHTMLX/5.1.0/Scheduler/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/DHTMLX/5.1.0/Scheduler/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/DHTMLX/5.1.0/Scheduler/index.js";
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/DHTMLX/5.1.0/Scheduler/index"
	};
})();
...
var _DATA = (function(){
	...
	return {
		...
		data : [
			{ id : 1, text : "Meeting", start_date : "11/11/2019 14:00", end_date : "11/11/2019 17:00" }
			, { id : 2, text : "Conference", start_date : "11/15/2019 12:00", end_date : "11/18/2019 19:00" }
			, { id : 3, text : "Interview", start_date : "11/24/2019 09:00", end_date : "11/24/2019 10:00" }
		]
...
function initialize()
{
	try
	{
		...
		else if( !initialize._bInit && window.scheduler )
		{
...
var _draw = function( data, options )
{
	...
	//그리기 위한 로직 추가;
	if( !_DHTMLX.SCHEDULER )
	{
		_DHTMLX.SCHEDULER = window.scheduler;
		_DHTMLX.SCHEDULER.config.xml_date = "%Y-%m-%d %H:%i";
		_DHTMLX.SCHEDULER.config.first_hour = 0;
		_DHTMLX.SCHEDULER.config.last_hour = 23;
		_DHTMLX.SCHEDULER.config.time_step = 30;//분 표시 단위;
		_DHTMLX.SCHEDULER.config.start_on_monday = true;
		_DHTMLX.SCHEDULER.config.auto_end_date = true;
		_DHTMLX.SCHEDULER.init( _ELS.ROOT.id, new Date(), "month" );
		_DHTMLX.SCHEDULER.clearAll();
	}
	var i=0, iLen=_DATA.data.length;
	var io;//_DATA.data[ i ];
	for( ; i<iLen; ++i )
	{
		io = _DATA.data[ i ];
		io.start_date = new Date( io.start_date );
		io.end_date = new Date( io.end_date );
	}

	_DHTMLX.SCHEDULER.parse( _DATA.data, _draw.dataType );
};
_draw.dataType = "json";
