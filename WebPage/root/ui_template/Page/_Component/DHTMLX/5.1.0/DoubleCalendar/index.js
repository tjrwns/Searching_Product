/*/
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/DoubleCalendar/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/DoubleCalendar/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/DoubleCalendar/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/DoubleCalendar/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/DoubleCalendar/index.html?url=http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/DoubleCalendar/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/DHTMLX/5.1.0/DoubleCalendar/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/DHTMLX/5.1.0/DoubleCalendar/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/DHTMLX/5.1.0/DoubleCalendar/index.js";
...
(function(){
	...
	window.b2link.util.importCSSsToHead( HOST + "/libs/dhtmlx/5.1.0/fonts/font_roboto/roboto.css"
		//, HOST + "/libs/dhtmlx/5.1.0/dhtmlxcalendar_dhx_skyblue.css"
		//, HOST + "/libs/dhtmlx/5.1.0/dhtmlxcalendar_dhx_terrace.css"
		//, HOST + "/libs/dhtmlx/5.1.0/dhtmlxcalendar_dhx_web.css"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxcalendar_material.css"
	);

	//JS;
	window.b2link.util.importJSsToHead( HOST + "/libs/dhtmlx/5.1.0/dhtmlxCommon/dhtmlxcommon-all.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxcalendar.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxcalendar_double.js"
		, initialize
	);
})();
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/DHTMLX/5.1.0/DoubleCalendar/index"
	};
})();
...
function initialize()
{
	try
	{
		...
		if( !window.dhtmlXDoubleCalendar )
		{
			initialize._TIMEOUT = window.setTimeout( initialize, 300 );
			return;
		}
		else if( !initialize._bInit && window.dhtmlXDoubleCalendar )
		{
...
var _dispose = function()
{
	...
	if( _DHTMLX.CALENDAR )
	{
		_DHTMLX.CALENDAR.unload();
		_DHTMLX.CALENDAR = null;
	}
...
var _draw = function( data, options )
{
	...
	_DHTMLX.CALENDAR = new dhtmlXDoubleCalendar( _ELS.ROOT );
	_DHTMLX.CALENDAR.show();

	_DHTMLX.CALENDAR.LEFT = _DHTMLX.CALENDAR.leftCalendar;
	_DHTMLX.CALENDAR.RIGHT = _DHTMLX.CALENDAR.rightCalendar;
};
...
var _getDates = function(){ return { start_date : _DHTMLX.CALENDAR.LEFT.getDate(), end_date : _DHTMLX.CALENDAR.RIGHT.getDate() }; };
var _setDates = function( d ){
	//버그있음. 하나씩만 업데이트되어 두번 호출;
	_DHTMLX.CALENDAR.setDates( d.start_date, d.end_date );
	_DHTMLX.CALENDAR.setDates( d.start_date, d.end_date );
};
...
(function(){
	var _ = _THIS;
		...
		_.getDates = _getDates;
		_.setDates = _setDates;
