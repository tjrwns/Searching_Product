/*/
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Message/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Message/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Message/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Message/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Message/index.html?url=http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Message/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/DHTMLX/5.1.0/Message/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/DHTMLX/5.1.0/Message/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/DHTMLX/5.1.0/Message/index.js";
...
(function(){
	...
	window.b2link.util.importCSSsToHead( HOST + "/libs/dhtmlx/5.1.0/fonts/font_roboto/roboto.css"
		//, HOST + "/libs/dhtmlx/5.1.0/dhtmlxmessage_dhx_skyblue.css"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxmessage_dhx_terrace.css"
		//, HOST + "/libs/dhtmlx/5.1.0/dhtmlxmessage_dhx_web.css"
		//, HOST + "/libs/dhtmlx/5.1.0/dhtmlxmessage_material.css"
	);

	//JS;
	window.b2link.util.importJSsToHead( HOST + "/libs/dhtmlx/5.1.0/dhtmlxCommon/dhtmlxcommon-all.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxmessage.js"
		, initialize
	);
})();
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/DHTMLX/5.1.0/Message/index"
	};
})();
...
var _DATA = (function(){
	...
	return {
		DHTMLX : { type : "alert", text : "abcde", ok : "OOOKKK" }
		//DHTMLX : { type : "alert-error", text : "error! don't do this." }
		//DHTMLX : { type : "alert-warning", text : "warning! please check again." }
		//DHTMLX : { type : "confirm", title : "choice", text : "continue?", callback : function( result ){ window.alert( "OK. Continue." ); } }
		//DHTMLX : { type : "confirm-error", title : "choice", text : "error. continue?", callback : function( result ){ window.alert( "OK. Continue." ); } }
		//DHTMLX : { type : "confirm-warning", title : "choice", text : "warning. continue?", callback : function( result ){ window.alert( "OK. Continue." ); } }
	};
	////[ SAMPLE ] - [ E ] - 자동 삭제;
})();
...
function initialize()
{
	try
	{
		...
		else if( !initialize._bInit && window.dhtmlx )
		{
...
var _draw = function( data, options )
{
	...
	if( !_DHTMLX.MESSAGE )
	{
		_DHTMLX.MESSAGE	= window.dhtmlx;
	}

	var d = data.DHTMLX;
	if( d.type.indexOf( "confirm" ) > -1  ) _DHTMLX.MESSAGE.confirm( d );
	else if( d.type.indexOf( "alert" ) > -1  ) _DHTMLX.MESSAGE.alert( d );
	else _DHTMLX.MESSAGE.message( d );
};
