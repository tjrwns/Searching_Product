 /*/
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Tree/index.html?width=500&height=500

//사이즈를 %로 적용;
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Tree/index.html?width=100%25&height=500
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Tree/index.html?width=100%25&height=800

//사이즈를 %로 적용 - Height는 적용 안됨;
http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Tree/index.html?width=100%25&height=100%25

http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Tree/index.html?url=http://localhost:49781/ui/Page/_Component/DHTMLX/5.1.0/Tree/index.json
http://dnsproxy.shop:49781/ui/Page/_Component/DHTMLX/5.1.0/Tree/index.html?url=http://dnsproxy.shop:49781/ui/Page/_Component/DHTMLX/5.1.0/Tree/index.json
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "ui/Page/_Component/DHTMLX/5.1.0/Tree/index.js";
...
(function(){
	...
	window.b2link.util.importCSSsToHead( HOST + "/libs/dhtmlx/5.1.0/fonts/font_roboto/roboto.css"
		//, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_dhx_skyblue.css"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_dhx_terrace.css"
		//, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_dhx_web.css"
		//, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_material.css"
	);

	//JS;
	window.b2link.util.importJSsToHead( HOST + "/libs/dhtmlx/5.1.0/dhtmlxCommon/dhtmlxcommon-all.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_json.js"
		/*/
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_attrs.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_dragin.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_ed.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_json.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_kn.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_lf.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_li.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_path.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_rl.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_sb.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_srnd.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_start.js"
		, HOST + "/libs/dhtmlx/5.1.0/dhtmlxtree_xw.js"
		//*/
		, initialize
	);
})();
...
var _IDS = (function(){
	return {
		ROOT : "ui/Page/_Component/DHTMLX/5.1.0/Tree/index"
	};
})();
...
function initialize()
{
	try
	{
		...
		else if( !initialize._bInit && window.dhtmlXTreeObject )
		{
			...
			//*/
			_DHTMLX.TREE = new dhtmlXTreeObject( _ELS.ROOT.id, _getWidth(), _getWidth(), 0 );
			_DHTMLX.TREE.setImagePath( window.b2link.url.getServerURL_WebServer_SCODE( "SYS0015" ) + "/libs/dhtmlx/5.1.0/imgs/dhxtree_terrace/" );
			_DHTMLX.TREE.setDataMode( "json" );
			/*/
			_DHTMLX.TREE = new dhtmlXTreeObject({
				parent : _ELS.ROOT.id
				, checkbox : true
				, image_path : window.b2link.url.getServerURL_WebServer_SCODE( "SYS0015" ) + "/libs/dhtmlx/5.1.0/imgs/dhxtree_terrace/"
				, json : null
			});
			//*/
 ...
 */
var _deleteItem = function( id, selectParent )
{
	if( _DHTMLX.TREE ) _DHTMLX.TREE.deleteItem( id, selectParent );
};
 ...
 * @param {String|Number} id
 */
var _focusItem = function( id )
{
	if( _DHTMLX.TREE ) _DHTMLX.TREE.focusItem( id );
};
...
{
	if( _DHTMLX.TREE ) _DHTMLX.TREE.closeAllItems();
};
...
var _draw = function( data, options )
{
	...
	_DHTMLX.TREE.parse( data.data, null, _draw.dataType );
};
_draw.dataType = "json";
...
var _getSelectedItem = function(){
	...
	{
		d = {
			id : _DHTMLX.TREE.getSelectedItemId()
			, text : _DHTMLX.TREE.getSelectedItemText()
		};
	}
	return d;
};
