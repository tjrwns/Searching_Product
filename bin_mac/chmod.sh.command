...
sudo chmod -R 755 ../HTTPServer_MongoDB/APIServer/bin_mac/*.command
#sudo chmod -R 755 ../HTTPServer_MongoDB/APIServer/bin_mac/*.sh
...
sudo chmod -R 755 ../MongoDB/3.4.5_x64__Mac/*.command
sudo chmod -R 755 ../MongoDB/3.4.5_x64__Mac/bin/*
