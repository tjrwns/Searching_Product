//----------------------------------------------------------------------------------------------------;
var fileNm = "js__b2link__sessionServer/mongodb/member/validate__add__member_basic.js";
 ...
 * </code>
 */
global.mongodb.member.validate__add__member_basic = function( d )
{
	//TtwLog.timeStamp( "---- [ S ] - global.mongodb.member.validate__add__member_basic():void----------" );
	...
	//--------------------------------------------------;
	//기본 코드 값 정의 후 수정하기 - 김현요 문의;
	//B2LiNK-B2Ker;
	//d.cd$authority_code = d.cd$authority_code || "";

	//B2LiNK-BrandPortal;
	//BOT : 3000001
	//ADMIN : 3000002
	//USER : 3000003
	d.cd$authority_code = d.cd$authority_code || 3000003;
	//--------------------------------------------------;
	...
	//TtwLog.timeStamp( "---- [ E ] - global.mongodb.member.validate__add__member_basic():void----------" );
};
