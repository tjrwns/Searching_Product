//----------------------------------------------------------------------------------------------------;
var fileNm = "js__b2link__SYS0310/b2link_router_external/_SITE_COLLECT_DATA/crud/addList.js";
...
var PATH_NAME = "addList";
var PATH_DBJS = global.b2link_router_external._SITE_COLLECT_DATA.PATH.crud + PATH_NAME + ".dbjs";
var PATH_URI = global.b2link_router_external._SITE_COLLECT_DATA.PATH.crud;
 ...
 * @example
 * <code>
	http://localhost:49780/_SITE_COLLECT_DATA/crud/addList?DATA={"_id":-1,"cd_b":"","nm_b":"","cd_s":"","nm_s":"","cd_p":"","nm_p":"","id_sku":null,"id_spu":null,"p":-1,"cd$BRAND":"","nm$BRAND":"","cd$SITE":"","nm$SITE":""}
 * </code>
 */
(function( req, res ){
	//global.TtwLog.timeStamp( "- [ S ] - " + "global._SITE_COLLECT_DATA.crud." + PATH_NAME + "():void----------" );
	...
	//q.DATA._id += "-" + Date.now();
	q.DATA = global.decodeURIComponent( q.DATA );
	var idx0 = q.DATA.indexOf( '"hostname"' );
	global.console.log( "\t- " + q.DATA.slice( idx0, q.DATA.length-1 ) );
	...
	//global.b2link.fs.writeQuery( global.b2link_router_external._SITE_COLLECT_DATA.PATH.crud + PATH_NAME + ".query", query );
	...
	//global.TtwLog.timeStamp( "- [ E ] - " + "global._SITE_COLLECT_DATA.crud." + PATH_NAME + "():void----------" );
});