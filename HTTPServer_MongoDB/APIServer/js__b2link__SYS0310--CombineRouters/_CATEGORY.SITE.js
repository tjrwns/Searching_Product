...
//*/
//----------------------------------------------------------------------------------------------------;
var fileNm = "/js__b2link__SYS0310/_CATEGODY.SITE.js";
...
(function(){
	...
	var PATH_KEY  = "/_CATEGORY.SITE/allList";
	 ...
	 * @example
	 * <code>
		http://localhost:49780/_CATEGORY.SITE/allList/
		http://localhost:49780/_CATEGORY.SITE/allList/?
	 * </code>
	 */
...
(function(){
	...
	var PATH_KEY  = "/_CATEGORY.SITE/allList__byCountry";
	var PATH_URI  = PATH_KEY + "/";
	var PATH_DBJS = global.SYS0310.ROUTER.CONST.PATH_COMMON_DBJS + PATH_KEY + ".dbjs";
	var PATH_CACHE= PATH_URI.replace( /\//gi, "-" );
	 ...
	 * @example
	 * <code>
		http://localhost:49780/_CATEGORY.SITE/allList__byCountry/
		http://localhost:49780/_CATEGORY.SITE/allList__byCountry/?
	 * </code>
	 */
	global.SYS0310.ROUTER.add( PATH_URI, function( req, res ){
