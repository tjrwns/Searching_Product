//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link/validate/global.b2link.validate.getCountryCDFromRequestKeyword__SYS0310.js";
...
{
	//global.RayLog.timeStamp( "- [ S ] - " + "_FN0():{null|uint}----------" );
	...
	//global.RayLog.timeStamp( "- [ E ] - " + "_FN0():{null|uint}----------return null;" );
	return null;
};
 ...
 */
global.b2link.validate.getCountryCDFromRequestKeyword__SYS0310 = function( str )
{
	global.RayLog.timeStamp( "---- [ S ] - " + "global.b2link.validate.getCountryCDFromRequestKeyword__SYS0310():{null|uint}----------" );
	...
	global.RayLog.timeStamp( "---- [ E ] - " + "global.b2link.validate.getCountryCDFromRequestKeyword__SYS0310():{null|uint}----------return 0;" );
