...
global.b2link_router.STATIC.CONFIG.URL = global.b2link_router.STATIC.CONFIG.URL || {};
global.b2link_router.STATIC.CONFIG.URL._COMMON = "http://localhost:49320/";//시스템 개별 정의;

global.b2link_router.STATIC.CONFIG.URL.MEMBER = global.b2link_router.STATIC.CONFIG.URL.MEMBER || {};
global.b2link_router.STATIC.CONFIG.URL.MEMBER.COMMON = global.b2link_router.STATIC.CONFIG.URL._COMMON + "member/";

global.b2link_router.STATIC.CONFIG.URL.MEMBER.MEMBER_SESSION = global.b2link_router.STATIC.CONFIG.URL.MEMBER.MEMBER_SESSION || {};
/*/
